...
<!-- PROFESSORI Menu -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                 <li><a href=""><i class="fa fa-circle-o"></i> Visualizza Prog. Did.</a></li>
                 '; if($_SESSION['logged']==true){
                 echo '
        ...
        <section class="content-header">
         <h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="">Visualizza Programmazione Didattica</a></li>
          </ol>
        </section>
...
<!--  TABELLA COMPLETA -->
              <div class="box">
				...
				<form action="http://localhost/IGES/Application%20Layer/GestioneProgrammazioneDidattica/PDFPrint/Stampa_ProgDid.php" method="get">
                 <h3 class="box-title">Programmazione Didattica</h3>
				  <div class="box-tools pull-right">
                  	...
                  	<button type="submit" class="btn btn-default btn-sm"><i class="fa fa-print">&nbsp&nbspPDF</i></button>
                ...
                <div class="box-body">
                	<p>
							<table align="center" class="table table-bordered table-striped"><tr>
								...
								<td>	
								<select class="form-control" name="anno" id="anno" style="width: 100px;" onchange="cercaProgrammazione('<?php echo $_SESSION['username'];?>')">
								</select>
								</td>
                            </tr></table>	
						</form>
...
<!-- FINE TABELLA -->
    ...
    <script type="text/javascript">
        ...
        function getAnnoAcc(){
            ...
            httpRequest.onreadystatechange = function(){
            	if(httpRequest.readyState == 4 && httpRequest.status == 200){
                    ...
                    //select dove aggiungere i nuovi elementi
                    var aa = document.getElementById("annoAcc");
            ...
            httpRequest.open("GET","http://localhost/IGES/Application%20Layer/GestioneProgrammazioneDidattica/Vis_Prd.php?laurea="+elem+"&id=anni",true);
            httpRequest.send("");
        }
        ...
        function cercaProgrammazione(utente){
            ...
            var accad = document.getElementById("annoAcc").value;
            
            //anno corso selezionato
            var aCorso = document.getElementById("anno").value;
            
            //console.log(elem+" - "+accad+" - "+aCorso+" utente "+utente);
            
            httpRequest.onreadystatechange = function(){
            	if(httpRequest.readyState == 4 && httpRequest.status == 200){
                	var response = httpRequest.responseText;
                    document.getElementById("example2").removeAttribute("style");
                    //seleziono il corpo tabella
                    var tab = document.getElementById("corpoTab");
					tab.innerHTML = response;
                    //alert(response);
               	}
            }
            httpRequest.open("GET","http://localhost/IGES/Application%20Layer/GestioneProgrammazioneDidattica/Vis_Prd.php?laurea="+elem+"&accademico="+accad+"&corso="+aCorso+"&utente="+utente+"&id=all",true);
            httpRequest.send("");
        }
    </script>
  </body>
