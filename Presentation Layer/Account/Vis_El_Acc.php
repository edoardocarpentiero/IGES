<!--
    ...
    relative agli account presenti nel database
...
<input type="hidden" name="nomepagina" value="/IGESPresentation%20Layer/index.php">
...
<!-- PROFESSORI Menu -->
            ...
            <li class="treeview">
             ...
             ';} echo ' </ul>
              ...
              <ul class="treeview-menu">
                <li><a href="Vis_Account.php"><i class="fa fa-circle-o"></i> Visualizza Account</a></li>
              </ul>
            </li>
';}
?>
