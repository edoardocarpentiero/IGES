...
<!--
	...
	Questa classe implementa l'interfaccia grafica che riguarda la visualizzazione delle informazioni
    relative all'account personale
...
<!-- DOCENTI Menu -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="Mod_Acc.php"><i class="fa fa-circle-o" style="font-size: 13px;"></i> Modifica Account</a></li>
...
<!-- PROFESSORI Menu -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                 <li><a href="../Prog/Vis_ProgD.php"  style="font-size: 13px;"><i class="fa fa-circle-o"></i> Visualizza Prog. Did.</a></li>
                 '; if($_SESSION['logged']==true){
                 echo '
             ...
             ';} echo ' </ul>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="Mod_AccP.php" style="font-size: 13px;"><i class="fa fa-circle-o"></i> Modifica Account</a></li>
              </ul>
            </li>
';}
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Account
            <small>Visualizza Account</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="">Visualizza Account</a></li>
          </ol>
        </section>
            ...
            <!-- Left col -->
			 <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title">Visualizza Account</h3>
                ...
                <form action="" method="get" class="">
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <?php
                        ...
                        $ris=$gestione->getAccount(0,$_SESSION['username']);
