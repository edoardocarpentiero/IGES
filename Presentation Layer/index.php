...
<html>
  <head>
    ...
    <style type="text/css">
      #inputLogin{background: transparent; border-style: none;
...
<!-- DOCENTI Menu -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="Account/Add_Acc.php" style="font-size: 13px;"><i class="fa fa-circle-o"></i> Aggiungi Account</a></li>
                <li><a href="Account/Del_Acc.php" style="font-size: 13px;"><i class="fa fa-circle-o"></i> Elimina Account</a></li>
                <li><a href="Account/Vis_Account.php" style="font-size: 13px;"><i class="fa fa-circle-o"></i> Visualizza Account</a></li>
                <li><a href="Account/Vis_El_Acc.php" style="font-size: 13px;"><i class="fa fa-circle-o"></i> Elenco Account</a></li>
...
<!--  
		  ...
		  <div style="text-align: center;">
	          <img alt="logoDIA" src="dist/img/logoDIA.png" height="79" width="400">
		  </div>
		   <div style="text-align: center;">
	          <img alt="logoPRD" src="dist/img/logoRidotto.png" >
		  </div>
-->
          <ol class="breadcrumb">
