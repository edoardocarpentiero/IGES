<!--
	...
	Questa classe implementa l'interfaccia grafica che riguarda la modifica dello stato di un docente
...
<!-- CORPO TABELLA -->
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php 
                    	//DA COMPLETARE CON L'INTERROGAZIONE DEL DB
                    	$i=1;
                    	echo '<tr>';
                    	echo '<td>Cognome '.$i.'</td>';
                    	echo '<td>Nome '.$i.'</td>';
                    	echo '<td>Ruolo '.$i.'</td>';
                    	echo '<td>SSD '.$i.'</td>';
                    	echo '<td><input type="radio" name="stato'.$i.'" value="attivo">Attivo</td>';
                    	echo '<td><input type="radio" name="stato'.$i.'" value="inattivo">Inattivo</td>';
                    	echo '</tr>';
                    ?>
					</tbody>
                    <tfoot></tfoot>
                  ...
                  <div class="box-footer" style="text-align: center;">
                  	<input type="button" onclick="" value="Salva Modifiche" class="btn btn-default btn-lg">
                  </div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
<!-- FINE TABELLA -->
