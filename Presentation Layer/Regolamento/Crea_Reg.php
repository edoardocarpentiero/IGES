...
<!--
	...
	Questa classe implementa l'interfaccia grafica per la creazione di un nuovo regolamento
            ...
            <!-- Left col -->
			 <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title">Crea Regolamento</h3>
                ...
                <div class="box-body">
                <form id="formRegolamento" action="Pag_Crea_Reg.php" method="POST"name="formRegolamento">
                	<input type="hidden" id="funzione" name="funzione" value="creaRegolamento">
		            <section class="col-lg-12">
			 			<div style="float: none;">
							<section class="col-lg-3">
								<input type="radio" name="corso" value="Laurea" id="laurea">
								<label>Laurea</label>
							</section>
							<section class="col-lg-3">
	                ...
	                <section class="col-lg-12">&nbsp;</section>
		 			...
		 			<section class="col-lg-12">
			 			<section class="col-lg-12">
			                <div style="float: none;">
								<label for="curr">Nome Curriculum</label>
		                    	<input type="text" class="form-control" id="curriculum" name="curr" onkeyup="controllaLunghezza(this.id);">
		                    </div>                  
			                <div style="float: none; text-align: center;">
								<section class="col-lg-12">&nbsp;</section>
		                    	<input type="button" class="btn btn-default btn-lg" name="crea" onclick="creaRegolamento()" value="Crea Regolamento">
		                    </div>
				        </section> <!-- right col -->
				       <section class="">
							  <!--<div style="float: none;">
								<label>Scegli Curriculum</label>
			                      <select class="form-control">
			                        <option>Curriculum 1</option>
			                        <option>Curriculum 2</option>
			                        <option>Curriculum 3</option>
			                        <option>Curriculum 4</option>
			                      </select>
		                    </div>         
			                <div style="float: none; text-align: center;">
								<section class="col-lg-12" style="text-align: center;">&nbsp;</section>
		                    	<!--<input type="button" class="btn btn-default btn-lg" name="crea" value="Eredita Regolamento">
		                    </div>-->
				        </section> <!-- right col -->
				     </section> <!-- right col -->
				     <section class="col-lg-12">&nbsp;</section>
...
<script>
function controllaLunghezza(id){
	denominazione=document.getElementById(id);
    if(denominazione.value.length>=30){
           n=denominazione.value.length-1;
           denominazione.value=denominazione.value.substr(0, n);
   	}

}
function creaRegolamento(){
	if((document.getElementById("laurea").checked || document.getElementById("magist").checked) && document.getElementById("curriculum").value!=""){
            var req=new XMLHttpRequest();
            req.onreadystatechange=function(){
                if(req.status==200 && req.readyState==4){
                    if(req.responseText==-1)
                    	alert("Regolamento già esistente!");
                    else
                       document.getElementById("formRegolamento").submit();
                }
            }
